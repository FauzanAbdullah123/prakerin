...
<body>
    ...
    <!-- ##### Contact Area Start ##### -->
    <div class="hero-contact-area bg-overlay clearfix" style="background-image: url(assets/frontend/img/bg-img/35.jpg)">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="single-cool-fact mb-100">
                                    <div class="scf-icon">
                                        <img src="{{ asset('assets/frontend/img/core-img/idea.png') }}" alt="">
                                    </div>
                                    <div class="scf-text">
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="single-cool-fact mb-100">
                                    <div class="scf-icon">
                                        <img src="{{ asset('assets/frontend/img/core-img/list.png') }}" alt="">
                                    </div>
                                    <div class="scf-text">
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="single-cool-fact mb-100">
                                    <div class="scf-icon">
                                        <img src="{{ asset('assets/frontend/img/core-img/id-card.png') }}" alt="">
                                    </div>
                                    <div class="scf-text">
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="single-cool-fact mb-100">
                                    <div class="scf-icon">
                                        <img src="{{ asset('assets/frontend/img/core-img/diamond.png') }}" alt="">
                                    </div>
                                    <div class="scf-text">
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="single-service-area mb-100">
                                <div class="icon mb-30">
                                    <img src="{{ asset('assets/frontend/img/core-img/id-card2.png') }}" alt="">
                                </div>
                                <div class="text">
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="single-service-area mb-100">
                                <div class="icon mb-30">
                                    <img src="{{ asset('assets/frontend/img/core-img/file.png') }}" alt="">
                                </div>
                                <div class="text">
                                    <h5>Latest News</h5>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vel tortor facilisis, volutpat nulla placerat, tincidunt mi.</p>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="single-service-area mb-100">
                                <div class="icon mb-30">
                                    <img src="{{ asset('assets/frontend/img/core-img/archive.png') }}" alt="">
                                </div>
                                <div class="text">
