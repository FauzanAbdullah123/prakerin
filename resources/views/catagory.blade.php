...
<body>
    ...
    <div class="catagory-featured-post bg-overlay clearfix" style="background-image: url(assets/frontend/img/bg-img/23.jpg)">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            ...
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/24.jpg') }}" alt=""></a>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/25.jpg') }}" alt=""></a>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/26.jpg') }}" alt=""></a>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/27.jpg') }}" alt=""></a>
                                            </div>
                ...
                <div class="col-12 col-sm-9 col-md-6 col-lg-4">
                    <div class="sidebar-area">
                        ...
                        <div class="single-widget-area add-widget mb-30">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/img/bg-img/add3.png') }}" alt="">
                            </a>
                        </div>
                        ...
                        <div class="single-widget-area news-widget mb-30">
                            ...
                            <div class="single-blog-post d-flex style-4 mb-30">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/19.jpg') }}" alt=""></a>
                                </div>
                            ...
                            <div class="single-blog-post d-flex style-4 mb-30">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/20.jpg') }}" alt=""></a>
                                </div>
    ...
    <div class="big-add-area">
        <div class="container-fluid">
            <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/add4.png') }}" alt=""></a>
        </div>
    </div>
    <!-- ##### Add Area End ##### -->
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-9">
                    ...
                    <div class="single-blog-post d-flex flex-wrap style-5 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/28.jpg') }}" alt=""></a>
                        </div>
                    ...
                    <div class="single-blog-post d-flex flex-wrap style-5 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/29.jpg') }}" alt=""></a>
                        </div>
                    ...
                    <div class="single-blog-post d-flex flex-wrap style-5 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/30.jpg') }}" alt=""></a>
                        </div>
