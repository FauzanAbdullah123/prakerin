...
<body>
    ...
    <!-- ##### Contact Area Start ##### -->
    <div class="hero-contact-area bg-overlay clearfix" style="background-image: url(assets/frontend/img/bg-img/34.jpg)">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-8">
                    <div class="contact-content mb-100">
                        ...
                        <!-- Logo -->
                        <a href="#" class="d-block mb-50"><img src="{{ asset('assets/frontend/img/core-img/logo.png') }}" alt=""></a>
